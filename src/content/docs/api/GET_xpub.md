---
title: Get HD Account
---

Request details about an HD account. If account does not exist, it must be created with [POST /xpub](/api/post_xpub), and this call will return an error.
