...
If accounts passed to `?active` do not exist, they will be created with a relayed call to the [POST /xpub](/api/post_xpub) mechanics if new or will be imported from external data sources.
